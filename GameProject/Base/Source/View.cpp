...
void View::Init()
{
	...
	m_lightPassParameters[LIGHT_PASS_UNIFORM_TYPE::U_LIGHT0_TYPE] = glGetUniformLocation(m_lightPassShaderID, "lights[0].type");
	m_lightPassParameters[LIGHT_PASS_UNIFORM_TYPE::U_LIGHT0_POSITION] = glGetUniformLocation(m_lightPassShaderID, "lights[0].position");
	m_lightPassParameters[LIGHT_PASS_UNIFORM_TYPE::U_LIGHT0_COLOR] = glGetUniformLocation(m_lightPassShaderID, "lights[0].color");
	m_lightPassParameters[LIGHT_PASS_UNIFORM_TYPE::U_LIGHT0_POWER] = glGetUniformLocation(m_lightPassShaderID, "lights[0].power");
	m_lightPassParameters[LIGHT_PASS_UNIFORM_TYPE::U_LIGHT0_KC] = glGetUniformLocation(m_lightPassShaderID, "lights[0].kC");
	m_lightPassParameters[LIGHT_PASS_UNIFORM_TYPE::U_LIGHT0_KL] = glGetUniformLocation(m_lightPassShaderID, "lights[0].kL");
	m_lightPassParameters[LIGHT_PASS_UNIFORM_TYPE::U_LIGHT0_KQ] = glGetUniformLocation(m_lightPassShaderID, "lights[0].kQ");
	m_lightPassParameters[LIGHT_PASS_UNIFORM_TYPE::U_LIGHT0_DIRECTION] = glGetUniformLocation(m_lightPassShaderID, "lights[0].direction");
	m_lightPassParameters[LIGHT_PASS_UNIFORM_TYPE::U_LIGHT0_COSCUTOFF] = glGetUniformLocation(m_lightPassShaderID, "lights[0].cosCutoff");
	m_lightPassParameters[LIGHT_PASS_UNIFORM_TYPE::U_LIGHT0_COSINNER] = glGetUniformLocation(m_lightPassShaderID, "lights[0].cosInner");
